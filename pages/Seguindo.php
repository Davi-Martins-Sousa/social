...
';
    echo "</br>";
    echo '<h2>Seguindo</h2>';
    $seguindo = getSeguindo(getConection(),$usuario_id);
    while ($registro = mysqli_fetch_assoc($seguindo)) {
        $id = $registro["id"];
        $nome = $registro["seguido"];
        echo '
          <div class="container">
            <form class="row g-3 needs-validation" action="" method="post" novalidate>
              ...
              <div class="col-md-6">
                  ...
                  <button class="btn btn-primary" type="deletar" name="deletar">Deixar de sequir</button>
              </div>
            </form>
          </div>';
    }
